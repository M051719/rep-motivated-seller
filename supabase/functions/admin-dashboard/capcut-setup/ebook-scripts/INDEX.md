...
ebook-scripts/
├── README.md (this file)
├── chapter-01-understanding-foreclosure.md ✅
├── chapter-02-emotional-journey.md ✅
├── chapter-03-online-communities.md ✅
├── chapter-04-preforeclosure-timeline.md ✅
├── chapter-05-short-sale-vs-foreclosure.md ✅
├── chapter-06-working-with-cash-buyers.md ✅
├── chapter-07-legal-rights.md (template ready)
├── chapter-08-rebuilding-future.md (template ready)
├── chapter-09-social-media-education.md (template ready)
├── chapter-10-avoiding-scams.md (template ready)
├── chapter-11-sharing-story-safely.md (template ready)
├── chapter-12-vetting-professionals.md (template ready)
├── chapter-13-financial-assessment.md (template ready)
├── chapter-14-lender-communication.md (template ready)
├── chapter-15-loan-modification.md (template ready)
├── chapter-16-building-support-network.md (template ready)
└── assets/
    ├── thumbnails/
    ├── graphics/
    └── templates/
