...
// IPv6 check for direct DB endpoint
console.log('Testing IPv6 (Direct Connection)...')
exec('ping -6 db.ltxqodqlexvojqqxquew.supabase.co', (error) => {
  if (error) {
...
// IPv4 check for pooler endpoint
console.log('Testing IPv4 (Shared Pooler)...')
exec('ping aws-0-us-east-2.pooler.supabase.com', (error) => {
  if (error) {
