    ...
    <div className={`p-3 rounded-lg border ${getStatusColor()}`}>
      ...
      {showDetails && status.details && (
        <div className="mt-3 space-y-1 text-sm border-t pt-2">
          <div
            className={
              status.details.environment ? "text-green-600" : "text-red-600"
            }
          >
          ...
          <div
            className={
              status.details.auth.success ? "text-green-600" : "text-red-600"
            }
          >
          ...
          <div
            className={
              status.details.database ? "text-green-600" : "text-red-600"
            }
          >
