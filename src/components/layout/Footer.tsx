      ...
      <div className="max-w-7xl mx-auto py-12 px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4">
              Helping homeowners avoid foreclosure through education, resources, and direct assistance.
            </p>
            <div className="space-y-2 text-sm text-gray-300">
              <p>
                📞 <a href={`tel:${import.meta.env.VITE_BUSINESS_PHONE || '+18778064677'}`} className="hover:text-white transition-colors">
                  {import.meta.env.VITE_BUSINESS_PHONE || '(877) 806-4677'}
                </a>
              </p>
              <p>
                📧 General: <a href="mailto:admin@repmotivatedseller.shoprealestatespace.org" className="hover:text-white transition-colors">
                  admin@repmotivatedseller.shoprealestatespace.org
                </a>
              </p>
              <p>
                🚨 Urgent: <a href="mailto:urgent@repmotivatedseller.shoprealestatespace.org" className="hover:text-white transition-colors text-red-400">
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <Link to="/foreclosure" className="block text-gray-300 hover:text-white transition-colors">Get Help</Link>
              ...
              <Link to="/subscription" className="block text-gray-300 hover:text-white transition-colors">Membership</Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <Link to="/terms-of-service" className="block text-gray-300 hover:text-white transition-colors">Terms of Service</Link>
              <Link to="/refund-policy" className="block text-gray-300 hover:text-white transition-colors">Refund Policy</Link>
              <Link to="/disclaimer" className="block text-gray-300 hover:text-white transition-colors">Disclaimer</Link>
              <Link to="/unsubscribe" className="block text-gray-300 hover:text-white transition-colors">Unsubscribe</Link>
              <Link to="/sitemap" className="block text-gray-300 hover:text-white transition-colors">Sitemap</Link>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8">
          <div className="flex justify-center space-x-6">
            <a href="https://www.facebook.com/profile.php?id=61571003534655" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors" aria-label="Facebook">
              <Facebook className="w-6 h-6" />
            </a>
            <a href="https://www.instagram.com/repmotivatedseller/" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors" aria-label="Instagram">
              <Instagram className="w-6 h-6" />
            </a>
            <a href="https://x.com/RepMotivated" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors" aria-label="X (Twitter)">
        ...
        <div className="border-t border-gray-700 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-300 text-sm">
              © {new Date().getFullYear()} RepMotivatedSeller. All rights reserved.
            </p>
            <div className="text-center mt-4 md:mt-0">
              <p className="text-gray-400 text-xs">
                📧 To opt out of marketing: <a href="mailto:optout@repmotivatedseller.org" className="text-blue-300 hover:text-blue-200">optout@repmotivatedseller.org</a>
              </p>
            </div>
          </div>
        </div>
