...
const DealAnalyzer: React.FC = () => {
  const [dealType, setDealType] = useState<"flip" | "rental" | "wholesale">(
    "flip",
  );
  ...
  const calculateFlipProfit = () => {
    const totalInvestment =
      analysis.purchasePrice + analysis.repairCosts + analysis.holdingCosts;
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setAnalysis({
                    ...analysis,
                    repairCosts: Number(e.target.value),
                  })
                }
              />
            </div>
