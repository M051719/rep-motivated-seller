          ...
          <div className="space-y-4">
            ...
            {selectedList && (
              <div className="p-4 bg-blue-50 rounded-lg">
                ...
                {(() => {
                  const list = mailingLists.find(l => l.id === selectedList);
                  const cost = LobService.calculateCost(list?.addresses.length || 0);
                  return (
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="space-y-4 mb-6">
            <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
              <h3 className="font-medium text-yellow-800 mb-2">⚠️ Final Review</h3>
              ...
              return (
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="p-3 bg-gray-50 rounded">
                    ...
                    <p className="text-lg">{list?.addresses.length || 0} addresses</p>
                  </div>
                  <div className="p-3 bg-gray-50 rounded">
                    <p className="text-sm font-medium text-gray-600">Total Cost</p>
                    <p className="text-lg font-bold text-green-600">${cost.totalCost.toFixed(2)}</p>
                  </div>
                  <div className="p-3 bg-gray-50 rounded">
                ...
                <div key={index} className={`p-2 border-b ${
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-sm">
                      {result.address.name} - {result.address.address_city}, {result.address.address_state}
                    </span>
