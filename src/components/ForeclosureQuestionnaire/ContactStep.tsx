    ...
    <div className="contact-step">
      ...
      <div className="sms-consent">
        <label className="checkbox-container">
          ...
          <span className="consent-text">
            ...
            regarding my foreclosure assistance inquiry. Message and data rates
            may apply. I can opt out at any time by replying STOP.
            <a href="/sms-terms" target="_blank">
              {" "}
              View SMS Terms
            </a>
          </span>
      ...
      <div className="sms-disclaimer">
        <p className="text-sm text-gray-600">
          ...
          to receive text messages from RepMotivatedSeller. You may receive up
          to 3 messages per week. Reply STOP to opt out or HELP for assistance.
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className="sms-terms-container">
      ...
      <section>
        ...
        <p>
          To stop receiving messages, text STOP to any message from us. You will
          receive a confirmation message. For help, text HELP.
        </p>
      </section>
...
// Note: SMS webhook handling should be in a Supabase Edge Function, not in browser code
// This is a placeholder for the frontend component
// The actual Twilio webhook handler should be in supabase/functions/sms-webhook

/* Example Edge Function code (move to supabase/functions/sms-webhook/index.ts):
serve(async (req) => {
  ...
  let responseMessage = "";  // Handle STOP keywords
  if (
