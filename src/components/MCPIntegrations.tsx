...
const MCPIntegrations: React.FC = () => {
  const mcpServices: MCPService[] = [
    {
      name: 'Claude Desktop',
      description: 'AI-powered assistant for intelligent data analysis and retrieval',
    ...
    {
      name: 'Cloudflare',
      description: 'Edge computing and content delivery for lightning-fast data access',
      ...
      knowledgeBaseLinks: ['Property Listings', 'Market Data', 'Public Records'],
      status: 'active',
    },
    {
      name: 'Dappier AI',
    ...
    },
    {
      ...
      knowledgeBaseLinks: ['Property Analysis', 'Risk Factors', 'Location Data'],
      status: 'active',
    },
    {
      name: 'StackHawk',
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-br from-purple-600 via-blue-600 to-indigo-600 rounded-2xl p-8 text-white">
        <div className="flex items-center space-x-4 mb-4">
          ...
          <div>
            <h2 className="text-3xl font-bold">Model Context Protocol (MCP) Integrations</h2>
        ...
        <div className="flex items-start space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-700 mb-3">
              Model Context Protocol (MCP) services connect our platform to external data sources,
              AI models, and cloud services. These integrations enable:
            </p>
            <ul className="space-y-2 text-sm text-gray-700">
              <li className="flex items-start">
                <span className="w-2 h-2 bg-blue-500 rounded-full mt-1.5 mr-2 flex-shrink-0"></span>
                <span>
                  <strong>Real-time data retrieval</strong> from government agencies, public
                  records, and market databases
                </span>
              </li>
              <li className="flex items-start">
                <span className="w-2 h-2 bg-blue-500 rounded-full mt-1.5 mr-2 flex-shrink-0"></span>
                <span>
                  <strong>AI-powered analysis</strong> of property values, market trends, and
              ...
              <li className="flex items-start">
                <span className="w-2 h-2 bg-blue-500 rounded-full mt-1.5 mr-2 flex-shrink-0"></span>
                <span>
                  <strong>Intelligent search</strong> across local, state, and federal real estate
                  resources
                </span>
              </li>
              <li className="flex items-start">
                <span className="w-2 h-2 bg-blue-500 rounded-full mt-1.5 mr-2 flex-shrink-0"></span>
                <span>
                  <strong>Automated data updates</strong> from news sources, educational materials,
                  and market reports
                </span>
              </li>
            </ul>
      ...
      <div className="bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200 rounded-2xl p-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            <h4 className="font-bold text-gray-900 mb-2">1. Ask the AI Assistant</h4>
            <p className="text-sm text-gray-700 mb-3">
              Use the floating AI chat button (bottom-right) to ask questions. The AI automatically
              queries relevant MCP services to find the best answers.
            </p>
          ...
          <div>
            <h4 className="font-bold text-gray-900 mb-2">2. Access Knowledge Base</h4>
            <p className="text-sm text-gray-700 mb-3">
              Navigate to the Knowledge Base page to browse categorized resources that pull live
              data from MCP services.
            </p>
            <div className="bg-white rounded-lg p-3 text-sm text-gray-600 italic border border-green-200">
          ...
          <div>
            <h4 className="font-bold text-gray-900 mb-2">3. Property Analysis Tools</h4>
            <p className="text-sm text-gray-700 mb-3">
              Our calculators use MCP integrations to fetch current market data, interest rates,
          ...
          <div>
            <h4 className="font-bold text-gray-900 mb-2">4. Educational Materials</h4>
            <p className="text-sm text-gray-700 mb-3">
              Educational content is continuously updated with the latest real estate trends, news,
              and regulations via MCP feeds.
            </p>
            <div className="bg-white rounded-lg p-3 text-sm text-gray-600 italic border border-green-200">
