...
export const UnderwritingAnalyzer: React.FC = () => {
  ...
  const results = useMemo(() => {
    ...
    const totalAcquisitionCost =
      purchasePrice + closingCosts + dueDiligenceCosts;
    const totalCapitalImprovements =
      immediateRepairs + capitalExpenditures + contingencyReserve;
    ...
    const effectiveGrossIncome =
      totalPotentialIncome - vacancyLoss - creditLoss;

    // Operating Expenses
    const propertyManagementFee =
      grossScheduledIncome * (propertyManagement / 100);
    ...
    const taxableIncome =
      netOperatingIncome - annualDebtService - annualDepreciation;
    const taxLiability =
      taxableIncome > 0 ? taxableIncome * (taxBracket / 100) : 0;
    ...
    const cashOnCashReturn =
      equityRequired > 0 ? (cashFlowAfterTax / equityRequired) * 100 : 0;
    const debtServiceCoverageRatio =
      annualDebtService > 0 ? netOperatingIncome / annualDebtService : 0;
    const grossRentMultiplier =
      grossScheduledIncome > 0 ? purchasePrice / grossScheduledIncome : 0;
    ...
    // Exit Analysis
    const futureNOI =
      netOperatingIncome * Math.pow(1 + appreciationRate / 100, holdingPeriod);
    const projectedSalePrice =
      exitCapRate > 0 ? futureNOI / (exitCapRate / 100) : 0;
    ...
    const equityMultiple =
      equityRequired > 0 ? (equityAtSale + totalCashFlow) / equityRequired : 0;
    const annualizedIRR =
      equityRequired > 0 && holdingPeriod > 0
        ? (Math.pow(equityMultiple, 1 / holdingPeriod) - 1) * 100
        : 0;

    // Sensitivity Analysis - Base Case
    const calculateScenario = (
      vacancyAdjust: number,
      ...
      const scenarioExpenses =
        totalOperatingExpenses * (1 + expenseAdjust / 100);
      const scenarioNOI = scenarioEGI - scenarioExpenses;
      const scenarioCashFlow = scenarioNOI - annualDebtService;
      const scenarioTaxableIncome =
        scenarioNOI - annualDebtService - annualDepreciation;
      const scenarioTax =
        scenarioTaxableIncome > 0
          ? scenarioTaxableIncome * (taxBracket / 100)
          : 0;
      const scenarioCashFlowAfterTax = scenarioCashFlow - scenarioTax;
      const scenarioDSCR =
        annualDebtService > 0 ? scenarioNOI / annualDebtService : 0;
      const scenarioCoCReturn =
        equityRequired > 0
          ? (scenarioCashFlowAfterTax / equityRequired) * 100
          : 0;
    ...
    const pessimisticCase = calculateScenario(
      pessimisticVacancy,
      pessimisticExpenseIncrease,
    );
      ...
      <div className="text-center px-8 py-12 bg-white rounded-2xl shadow-2xl max-w-2xl mx-4">
        ...
        <div className="grid md:grid-cols-2 gap-4 mb-8 text-left">
          ...
          <div className="flex items-start space-x-3">
            <CheckCircle className="w-5 h-5 text-green-600 mt-1 flex-shrink-0" />
            <span className="text-gray-700">
              Tax-adjusted cash flow projections
            </span>
          </div>
          <div className="flex items-start space-x-3">
            <CheckCircle className="w-5 h-5 text-green-600 mt-1 flex-shrink-0" />
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateInput("propertyAddress", e.target.value)
                    }
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      updateInput("propertyType", e.target.value)
                    }
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateInput("yearBuilt", Number(e.target.value))
                      }
                      className="w-full px-4 py-2 border-2 border-blue-200 rounded-lg focus:ring-2 focus:ring-blue-500"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      value={inputs.units}
                      onChange={(e) =>
                        updateInput("units", Number(e.target.value))
                      }
                      className="w-full px-4 py-2 border-2 border-blue-200 rounded-lg focus:ring-2 focus:ring-blue-500"
                    />
                  </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateInput("squareFeet", Number(e.target.value))
                    }
                    className="w-full px-4 py-2 border-2 border-blue-200 rounded-lg focus:ring-2 focus:ring-blue-500"
                  />
                </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateInput("closingCosts", Number(e.target.value))
                    }
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateInput("dueDiligenceCosts", Number(e.target.value))
                    }
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                  />
                </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateInput("immediateRepairs", Number(e.target.value))
                    }
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateInput("capitalExpenditures", Number(e.target.value))
                    }
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateInput("contingencyReserve", Number(e.target.value))
                    }
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                  />
                </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateInput("otherIncome", Number(e.target.value))
                    }
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                  />
                </div>
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateInput("creditLossRate", Number(e.target.value))
                      }
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                    />
                  </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateInput("propertyTaxes", Number(e.target.value))
                      }
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateInput("utilities", Number(e.target.value))
                      }
                      className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateInput("reserves", Number(e.target.value))
                      }
                      className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                    />
                  </div>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateInput("holdingPeriod", Number(e.target.value))
                      }
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateInput("appreciationRate", Number(e.target.value))
                      }
                      className="w-full px-4 py-2 border border-purple-300 rounded-lg focus:ring-2 focus:ring-purple-500"
                    />
                  </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateInput("exitCapRate", Number(e.target.value))
                    }
                    className="w-full px-4 py-2 border border-purple-300 rounded-lg focus:ring-2 focus:ring-purple-500"
                  />
                </div>
          ...
          <div className="lg:col-span-2 space-y-6">
                ...
                <table className="min-w-full">
                  <thead>
                    <tr className="border-b-2 border-orange-300">
                      ...
                      <th className="px-4 py-3 text-center text-sm font-bold text-red-700">
                        Pessimistic
                      </th>
                  ...
                  <tbody className="bg-white">
                    <tr className="border-b border-gray-200">
                      ...
                      <td className="px-4 py-3 text-center text-red-600 font-semibold">
                        {formatCurrency(results!.pessimisticCase.noi)}
                      </td>
                      <td className="px-4 py-3 text-center text-blue-600 font-semibold">
                        {formatCurrency(results!.baseCase.noi)}
                      </td>
                      <td className="px-4 py-3 text-center text-green-600 font-semibold">
                        {formatCurrency(results!.optimisticCase.noi)}
                      </td>
                    </tr>
                    <tr className="border-b border-gray-200">
                      <td className="px-4 py-3 font-medium text-gray-900">
                      ...
                      <td className="px-4 py-3 text-center text-red-600 font-semibold">
                        {formatCurrency(results!.pessimisticCase.cashFlow)}
                      </td>
                      <td className="px-4 py-3 text-center text-blue-600 font-semibold">
                        {formatCurrency(results!.baseCase.cashFlow)}
                      </td>
                      <td className="px-4 py-3 text-center text-green-600 font-semibold">
                        {formatCurrency(results!.optimisticCase.cashFlow)}
                      </td>
                    </tr>
                    <tr className="border-b border-gray-200">
                      <td className="px-4 py-3 font-medium text-gray-900">
                      ...
                      <td className="px-4 py-3 text-center text-red-600 font-semibold">
                        {results!.pessimisticCase.dscr.toFixed(2)}x
                      </td>
                      <td className="px-4 py-3 text-center text-blue-600 font-semibold">
                        {results!.baseCase.dscr.toFixed(2)}x
                      </td>
                      <td className="px-4 py-3 text-center text-green-600 font-semibold">
                        {results!.optimisticCase.dscr.toFixed(2)}x
                      </td>
                    </tr>
                    <tr>
                      <td className="px-4 py-3 font-medium text-gray-900">
                      ...
                      <td className="px-4 py-3 text-center text-red-600 font-semibold">
                        {formatPercent(results!.pessimisticCase.cocReturn)}
                      </td>
                      <td className="px-4 py-3 text-center text-blue-600 font-semibold">
                        {formatPercent(results!.baseCase.cocReturn)}
                      </td>
                      <td className="px-4 py-3 text-center text-green-600 font-semibold">
                        {formatPercent(results!.optimisticCase.cocReturn)}
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="bg-white rounded-lg p-4 shadow-md border border-indigo-100">
                  ...
                  <p className="text-2xl font-bold text-green-600">
                    {formatCurrency(results!.equityAtSale)}
                  </p>
                </div>
                <div className="bg-white rounded-lg p-4 shadow-md border border-indigo-100">
                ...
                <div className="bg-white rounded-lg p-4 shadow-md border border-indigo-100">
                  ...
                  <p className="text-2xl font-bold text-blue-600">
                    {formatMultiple(results!.equityMultiple)}
                  </p>
                </div>
                <div className="bg-white rounded-lg p-4 shadow-md border border-indigo-100">
                  <p className="text-sm text-gray-600 mb-1">Annualized IRR</p>
                  <p className="text-2xl font-bold text-green-600">
                    {formatPercent(results!.annualizedIRR)}
                  </p>
                </div>
                <div className="bg-white rounded-lg p-4 shadow-md border border-indigo-100">
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center pb-3 border-b">
                    ...
                    <span
                      className={`font-bold text-lg ${results!.debtServiceCoverageRatio >= 1.25 ? "text-green-600" : "text-red-600"}`}
                    >
                  ...
                  <div className="flex justify-between items-center pb-3 border-b">
                    ...
                    <span className="font-bold text-lg text-orange-600">
                      {formatPercent(results!.breakEvenOccupancy)}
                    </span>
                  </div>
                  <div className="flex justify-between items-center pb-3 border-b">
                    <span className="text-gray-700 font-medium">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-bold text-lg text-green-600">
                      {formatCurrency(results!.cashFlowAfterTax)}
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div
              className={`rounded-xl p-6 border-2 ${
                results!.annualizedIRR >= 15 &&
                results!.debtServiceCoverageRatio >= 1.25
                  ? "bg-green-50 border-green-400"
                  : results!.annualizedIRR >= 10 &&
                      results!.debtServiceCoverageRatio >= 1.15
