...
export const DSCRCalculator: React.FC = () => {
  ...
  const dscr = inputs.annualDebtPayment > 0 ? noi / inputs.annualDebtPayment : 0;
  ...
  const getDSCRGrade = (ratio: number) => {
    if (ratio >= 1.5) return { grade: 'Excellent', color: 'green', desc: 'Strong debt coverage', icon: CheckCircle };
    if (ratio >= 1.25) return { grade: 'Good', color: 'blue', desc: 'Healthy coverage', icon: CheckCircle };
    if (ratio >= 1.0) return { grade: 'Acceptable', color: 'yellow', desc: 'Minimal coverage', icon: AlertCircle };
    return { grade: 'Risky', color: 'red', desc: 'Insufficient coverage', icon: AlertCircle };
  };
  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl p-8">
      <div className="text-center mb-8">
        ...
        <h2 className="text-3xl font-bold text-gray-900 mb-2">DSCR Calculator</h2>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-gray-500">
              Taxes, insurance, maintenance, management (excludes mortgage principal)
            </p>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={(e) => setInputs({ ...inputs, annualDebtPayment: Number(e.target.value) })}
                className="w-full pl-10 pr-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-lg"
              />
            </div>
            <p className="mt-1 text-xs text-gray-500">
        ...
        <div className="space-y-4">
          ...
          >
            ...
            <div className={`mt-3 inline-block px-3 py-1 bg-white bg-opacity-20 rounded-full text-sm font-semibold`}>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              <div className="text-blue-100 text-sm mb-1">Net Operating Income</div>
              <div className="text-2xl font-bold">${noi.toLocaleString()}</div>
              <div className="text-xs text-blue-200 mt-1">${monthlyNOI.toLocaleString()}/mo</div>
            </motion.div>
            ...
            >
              <div className="text-emerald-100 text-sm mb-1">Annual Cash Flow</div>
          ...
          <div className="bg-gray-50 rounded-xl p-6">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between border-t pt-2">
                <span className="text-gray-700 font-medium">Net Operating Income:</span>
                <span className="font-bold text-gray-900">
                  ${noi.toLocaleString()}
                </span>
              </div>
              <div className="flex justify-between border-t pt-2 mt-2">
                <span className="text-gray-700 font-medium">Annual Debt Service:</span>
                <span className="font-bold text-gray-900">
      ...
      <div className="mt-8 bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-6">
        <h3 className="font-bold text-gray-900 mb-4">DSCR Requirements Guide</h3>
        <div className="grid md:grid-cols-4 gap-4">
          <div className="bg-white rounded-lg p-4">
            <div className="text-green-600 font-bold text-lg mb-1">1.5+</div>
            <div className="text-sm text-gray-600">Excellent - Most lenders love this</div>
          </div>
          <div className="bg-white rounded-lg p-4">
            <div className="text-blue-600 font-bold text-lg mb-1">1.25-1.5</div>
            <div className="text-sm text-gray-600">Good - Solid coverage, widely acceptable</div>
          </div>
          <div className="bg-white rounded-lg p-4">
            <div className="text-yellow-600 font-bold text-lg mb-1">1.0-1.25</div>
            <div className="text-sm text-gray-600">Acceptable - Minimum for some lenders</div>
          </div>
          <div className="bg-white rounded-lg p-4">
            <div className="text-red-600 font-bold text-lg mb-1">&lt;1.0</div>
            <div className="text-sm text-gray-600">Risky - Difficult to finance</div>
          </div>
        </div>

        <div className="mt-4 grid md:grid-cols-2 gap-4">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <h4 className="font-semibold text-blue-900 mb-2">Why DSCR Matters</h4>
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-4">
            <h4 className="font-semibold text-green-900 mb-2">Improving Your DSCR</h4>
        ...
        <div className="mt-4 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          ...
          <p className="text-sm text-yellow-800">
            <strong>DSCR loans</strong> focus on property cash flow, not personal income. These are popular for real estate investors 
            who don't want to qualify based on W-2 income. Expect DSCR minimums of 1.0-1.25x depending on the lender, with 
            rates typically 0.5-1% higher than conventional loans. A DSCR below 1.0 means the property doesn't generate enough 
            income to cover its debt, requiring you to cover the shortfall from other sources.
          </p>
        </div>
      </div>
    </div>
