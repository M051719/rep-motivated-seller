...
export const RentalAnalyzer: React.FC<RentalAnalyzerProps> = ({
  mode = "basic",
}) => {
  ...
  const results = useMemo(() => {
    ...
    const propertyManagementFee =
      grossMonthlyIncome * (propertyManagement / 100);
    ...
    const capRate =
      purchasePrice > 0
        ? ((annualCashFlow + monthlyMortgage * 12) / purchasePrice) * 100
        : 0;
    const grossRentMultiplier =
      monthlyRent > 0 ? purchasePrice / (monthlyRent * 12) : 0;
    const debtServiceCoverageRatio =
      monthlyMortgage > 0 ? effectiveMonthlyIncome / monthlyMortgage : 0;
    ...
    if (showAdvanced && inputs.appreciationRate && inputs.holdingYears) {
      futureValue =
        purchasePrice *
        Math.pow(1 + inputs.appreciationRate / 100, inputs.holdingYears);
      ...
      if (inputs.incomeGrowthRate && inputs.expenseGrowthRate) {
        const futureIncome =
          ...
          Math.pow(1 + inputs.incomeGrowthRate / 100, inputs.holdingYears);
        const futureExpenses =
          (totalMonthlyExpenses - monthlyMortgage) *
          Math.pow(1 + inputs.expenseGrowthRate / 100, inputs.holdingYears);
        projectedCashFlow =
          (futureIncome - futureExpenses - monthlyMortgage) * 12;
      }
    }
    ...
    <div className="absolute inset-0 bg-gray-900/80 backdrop-blur-sm rounded-lg flex items-center justify-center z-10">
      <div className="text-center px-6 py-8 bg-white rounded-xl shadow-2xl max-w-md">
        ...
        <p className="text-gray-600 mb-6">
          Unlock advanced rental analysis with 5-year projections, appreciation
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateInput("repairCosts", Number(e.target.value))
                    }
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"
                  />
                </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateInput("otherMonthlyIncome", Number(e.target.value))
                    }
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"
                  />
                </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateInput("propertyTax", Number(e.target.value))
                    }
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateInput("hoaFees", Number(e.target.value))
                    }
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateInput("propertyManagement", Number(e.target.value))
                    }
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"
                  />
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateInput("incomeGrowthRate", Number(e.target.value))
                      }
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500"
                      disabled={!isProOrEnterprise}
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateInput("expenseGrowthRate", Number(e.target.value))
                      }
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500"
                      disabled={!isProOrEnterprise}
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateInput("holdingYears", Number(e.target.value))
                      }
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500"
                      disabled={!isProOrEnterprise}
                    />
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg p-6 border-2 border-green-200">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-white rounded-lg p-4 shadow-sm">
                  ...
                  <p
                    className={`text-xl font-bold ${results.cashOnCashReturn >= 8 ? "text-green-600" : "text-orange-600"}`}
                  >
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center pb-2 border-b">
                  ...
                  <span className="font-semibold">
                    {formatCurrency(inputs.closingCosts + inputs.repairCosts)}
                  </span>
                </div>
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center pb-2 border-b bg-green-50 p-2 rounded">
                  ...
                  <span className="font-bold text-green-600">
                    {formatCurrency(results.grossMonthlyIncome)}
                  </span>
                </div>
                <div className="flex justify-between items-center pb-2 border-b">
                ...
                <div className="flex justify-between items-center pb-2 border-b">
                  ...
                  <span className="font-semibold">
                    {formatCurrency(inputs.maintenance)}
                  </span>
                </div>
                <div className="flex justify-between items-center pb-2 border-b">
                  <span className="text-gray-700">Property Management</span>
                  <span className="font-semibold">
                    {formatCurrency(results.propertyManagementFee)}
                  </span>
                </div>
                {inputs.utilities > 0 && (
                  <div className="flex justify-between items-center pb-2 border-b">
                    ...
                    <span className="font-semibold">
                      {formatCurrency(inputs.utilities)}
                    </span>
                  </div>
                )}
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center pb-2 border-b">
                  ...
                  <span
                    className={`font-semibold ${results.onePercentRule >= 1 ? "text-green-600" : "text-orange-600"}`}
                  >
                    {formatPercent(results.onePercentRule)}{" "}
                    {results.onePercentRule >= 1 ? "✅" : "⚠️"}
                  </span>
                </div>
                <div className="flex justify-between items-center pb-2 border-b">
                  <span className="text-gray-700">Debt Service Coverage</span>
                  <span
                    className={`font-semibold ${results.debtServiceCoverageRatio >= 1.25 ? "text-green-600" : "text-orange-600"}`}
                  >
                    {results.debtServiceCoverageRatio.toFixed(2)}x{" "}
                    {results.debtServiceCoverageRatio >= 1.25 ? "✅" : "⚠️"}
                  </span>
                </div>
