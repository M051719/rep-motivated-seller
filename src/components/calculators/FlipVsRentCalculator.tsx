...
export const FlipVsRentCalculator: React.FC = () => {
  ...
  const monthlyCashFlow = effectiveMonthlyRent - managementFee - monthlyExpenses;
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-8">
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setFlipHoldingTime(parseFloat(e.target.value) || 0)}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setFlipClosingCosts(parseFloat(e.target.value) || 0)}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setRealtorCommission(parseFloat(e.target.value) || 0)}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
            </div>
          ...
          <div className="bg-green-50 rounded-lg p-6">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <h3 className="text-xl font-bold text-gray-900">Rental Scenario</h3>
            </div>
        ...
        <div className="space-y-6">
          {/* Recommendation */}
          <div className={`rounded-xl p-6 ${recommendation.color} border-2 border-current`}>
            ...
            <div className="space-y-3">
              <div className="bg-white rounded-lg p-4">
                ...
                <div className="text-2xl font-bold text-blue-600">
                  ${flipNetProfit.toLocaleString('en-US', { minimumFractionDigits: 0, maximumFractionDigits: 0 })}
                </div>
              </div>
          ...
          <div className="bg-green-50 rounded-xl p-6">
            <div className="flex items-center space-x-2 mb-4">
              <TrendingUp className="w-6 h-6 text-green-600" />
              <h3 className="text-xl font-bold text-gray-900">Rental Analysis</h3>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="bg-white rounded-lg p-4">
                ...
                <div className="text-2xl font-bold text-green-600">
                  ${total5YearReturn.toLocaleString('en-US', { minimumFractionDigits: 0, maximumFractionDigits: 0 })}
                </div>
          ...
          <div className="bg-gray-50 rounded-xl p-6">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex justify-between py-2 border-b">
                ...
                <span className="font-semibold">Flip: ${flipNetProfit.toLocaleString()} vs Rent: ${annualCashFlow.toLocaleString()}/yr</span>
              </div>
              <div className="flex justify-between py-2 border-b">
                <span className="text-gray-600">Time to Profit</span>
                <span className="font-semibold">Flip: {flipHoldingTime}mo vs Rent: Ongoing</span>
              </div>
              <div className="flex justify-between py-2 border-b">
                <span className="text-gray-600">Risk Level</span>
                <span className="font-semibold">Flip: Higher vs Rent: Lower</span>
              </div>
              <div className="flex justify-between py-2">
                <span className="text-gray-600">Long-term Wealth</span>
                <span className="font-semibold">Flip: One-time vs Rent: Compounding</span>
              </div>
            </div>
          </div>
        </div>
