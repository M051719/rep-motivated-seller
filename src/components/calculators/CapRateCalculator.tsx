...
export const CapRateCalculator: React.FC = () => {
  ...
  const getCapRateGrade = (rate: number) => {
    if (rate >= 8) return { grade: 'Excellent', color: 'green', desc: 'Strong cash flow property' };
    if (rate >= 6) return { grade: 'Good', color: 'blue', desc: 'Solid investment' };
    if (rate >= 4) return { grade: 'Fair', color: 'yellow', desc: 'Average performance' };
  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl p-8">
      <div className="text-center mb-8">
        ...
        <h2 className="text-3xl font-bold text-gray-900 mb-2">Cap Rate Calculator</h2>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-gray-500">
              Includes taxes, insurance, maintenance, management, utilities (excludes mortgage)
            </p>
          </div>
        </div>
          ...
          <div className="bg-gray-50 rounded-xl p-6">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between text-xs text-gray-500 mt-3">
                ...
                <span>{((inputs.annualExpenses / inputs.annualIncome) * 100).toFixed(1)}%</span>
              </div>
            </div>
          </div>
      ...
      <div className="mt-8 bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-6">
        <h3 className="font-bold text-gray-900 mb-4">Cap Rate Investment Guide</h3>
        <div className="grid md:grid-cols-4 gap-4">
          <div className="bg-white rounded-lg p-4">
            <div className="text-green-600 font-bold text-lg mb-1">8%+</div>
            <div className="text-sm text-gray-600">Excellent cash flow, higher risk markets</div>
          </div>
          <div className="bg-white rounded-lg p-4">
            <div className="text-blue-600 font-bold text-lg mb-1">6-8%</div>
            <div className="text-sm text-gray-600">Good balance of income and appreciation</div>
          </div>
          <div className="bg-white rounded-lg p-4">
            <div className="text-yellow-600 font-bold text-lg mb-1">4-6%</div>
            <div className="text-sm text-gray-600">Lower yield, stable appreciation markets</div>
          </div>
          <div className="bg-white rounded-lg p-4">
            <div className="text-red-600 font-bold text-lg mb-1">&lt;4%</div>
            <div className="text-sm text-gray-600">Premium markets, appreciation focused</div>
          </div>
        </div>

        <div className="mt-4 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          <p className="text-sm text-yellow-800">
            <strong>💡 Note:</strong> Cap rates vary by market and property type. Higher cap rates often indicate 
            higher risk or less desirable locations. Lower cap rates are common in premium markets with strong appreciation.
          </p>
        </div>
      </div>
    </div>
