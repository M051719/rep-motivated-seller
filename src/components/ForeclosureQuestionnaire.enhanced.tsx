...
const ForeclosureQuestionnaireEnhancement: React.FC<QuestionnaireEnhancementProps> = ({
  existingData,
  onEnhancedComplete
}) => {
  ...
  const generateAIRecommendations = () => {
    ...
    if (monthsBehind >= 3) {
      recommendations.push({
        ...
        description: 'Contact your lender immediately to discuss loss mitigation options',
    ...
    recommendations.push({
      ...
      description: 'Learn your options and rights through our free education program',
    ...
    <div className="questionnaire-enhancement max-w-4xl mx-auto p-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className={`font-semibold ${
                    urgencyLevel === 'high' ? 'text-red-900' :
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg text-sm font-medium ${
                  urgencyLevel === 'high' ? 'bg-red-600 text-white hover:bg-red-700' :
                  urgencyLevel === 'medium' ? 'bg-yellow-600 text-white hover:bg-yellow-700' :
      ...
      <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            >
              ...
              {question.type === 'select' ? (
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                  required={question.required}
                  placeholder={question.type === 'number' ? 'Enter amount' : 'Your response'}
                />
              )}
            </motion.div>
          ))}
        ...
        <div className="flex justify-between mt-8">
          ...
          >
            {currentStep === enhancedSteps.length ? 'Complete Assessment' : 'Next'}
          </button>
        </div>
      </div>
        ...
        >
          <div className="text-center">
            ...
            <p className="text-gray-700 mb-6">
              Our AI has analyzed your situation and generated personalized recommendations.
            </p>
