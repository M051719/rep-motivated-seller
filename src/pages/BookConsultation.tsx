            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-yellow-700">
                  <strong>Configuration Required:</strong> VITE_CALENDLY_URL is
                  not set in your environment variables. Please add your
                  Calendly scheduling page URL to continue.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600 text-sm">
                    We'll outline potential strategies and solutions tailored to
                    you
                  </p>
                </div>
              </div>
        ...
        <div className="mt-12 bg-blue-50 rounded-lg p-6">
          ...
          <p className="text-gray-700 text-sm">
            All information shared during your consultation is kept strictly
            confidential and complies with GLBA Privacy Rules and industry best
            practices. We never share your personal information without your
            explicit consent. Read our{" "}
            <a
              href="/compliance/glba"
