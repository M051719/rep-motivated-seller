                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                  ...
                  <div>
                    ...
                    <ImageUploader
                      ...
                      onImageRemoved={() => setFormData({ ...formData, featured_image_url: '' })}
                      bucket="blog-images"
                      folder="featured"
                      maxSizeMB={5}
                    />
                  ...
                  <div className="border-t pt-6 mt-6">
                    ...
                    <p className="text-sm text-gray-600 mb-6">
                      Optimize your blog post for search engines and social media. Leave fields empty to auto-generate from title and excerpt.
                    </p>
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">
                          Meta Title
                          <span className="text-xs text-gray-500 ml-2">(max 70 chars, leave empty to use post title)</span>
                        </label>
                        <input
                          type="text"
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">
                          Meta Description
                          <span className="text-xs text-gray-500 ml-2">(max 160 chars, leave empty to use excerpt)</span>
                        </label>
                        <textarea
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">
                          Open Graph Title
                          <span className="text-xs text-gray-500 ml-2">(for social media, max 100 chars)</span>
                        </label>
                        <input
                          type="text"
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">
                          Open Graph Description
                          <span className="text-xs text-gray-500 ml-2">(for social media, max 200 chars)</span>
                        </label>
                        <textarea
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">
                          Open Graph Image URL
                          <span className="text-xs text-gray-500 ml-2">(leave empty to use featured image)</span>
                        </label>
                        <input
                          type="url"
                      ...
                      <div>
                        ...
                        >
                          ...
                          <option value="noindex, follow">No Index, Follow (don't show in search)</option>
                          <option value="index, nofollow">Index, No Follow (show but don't follow links)</option>
                          <option value="noindex, nofollow">No Index, No Follow (completely block)</option>
                        </select>
                      </div>
                    </div>
                  </div>
