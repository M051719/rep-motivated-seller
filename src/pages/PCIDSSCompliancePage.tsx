      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600">
            Your payment information is secure. Learn about our PCI DSS
          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-sm text-green-700 mt-1">
                We maintain the highest level of PCI DSS compliance through our
        ...
        <section className="bg-white rounded-lg shadow-md p-8 mb-8">
          ...
          <p className="text-gray-600">
            PCI DSS was created by major card brands including Visa, Mastercard,
            American Express, Discover, and JCB to protect cardholder data and
          ...
          <div className="space-y-4">
            <div className="border-l-4 border-blue-500 pl-4">
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-600 mt-2 ml-4">
                <li>
                  Install and maintain firewall configuration to protect
                  cardholder data
                </li>
                <li>
        ...
        <section className="bg-white rounded-lg shadow-md p-8 mb-8">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-600">
                We use Stripe, a PCI DSS Level 1 certified payment processor, to
                handle all credit card transactions. Your payment information
                never touches our servers - it goes directly to Stripe's secure,
                encrypted systems.
              </p>
            </div>
            <div>
              ...
              <p className="text-gray-600">
                ...
                and AES-256 encryption at rest. We never store complete credit
                card numbers, CVV codes, or PIN numbers.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-gray-800 mb-3 flex items-center">
              ...
              <p className="text-gray-600">
                Instead of storing card details, we use secure tokens provided
                by Stripe. These tokens are useless to anyone who might
                intercept them and cannot be reverse-engineered to reveal card
                information.
              </p>
            </div>
            <div>
              ...
              <p className="text-gray-600">
                We undergo regular security assessments and vulnerability scans
                to ensure our systems remain secure and compliant with the
            ...
            <div>
              ...
              <p className="text-gray-600">
                Stripe's advanced fraud detection systems, powered by machine
                learning, monitor transactions 24/7 to identify and prevent
                fraudulent activity.
              </p>
            </div>
          </div>
        ...
        <section className="bg-white rounded-lg shadow-md p-8 mb-8">
          ...
          <p className="text-gray-600 mb-4">
            When you make a payment, the following information is securely
            processed by Stripe:
          </p>
          ...
          <p className="text-gray-600 mt-4">
            <strong>What we do NOT store:</strong> We never store complete
            credit card numbers, CVV/CVC codes, or magnetic stripe data. Only
            Stripe has access to your full payment card details.
          </p>
        </section>
        ...
        <section className="bg-white rounded-lg shadow-md p-8 mb-8">
          ...
          <div className="space-y-4">
            <div>
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-600 ml-4">
                <li>
                  Request information about how your payment data is processed
                </li>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-600 ml-4">
                ...
                <li>
                  Review your account statements regularly for unauthorized
                  charges
                </li>
        ...
        <section className="bg-white rounded-lg shadow-md p-8">
          ...
          <p className="text-gray-600 mb-4">
            If you have questions about our payment security practices or wish
          ...
          <div className="space-y-3">
            <div>
              <strong>Email:</strong>{" "}
              <a
                href="mailto:privacy@repmotivatedseller.shoprealestatespace.org"
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            ...
            <p className="text-sm text-gray-500 mt-2">
              This page describes our commitment to PCI DSS compliance. For
              information about how we use your personal information, please see
              our{" "}
