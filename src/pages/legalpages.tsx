  ...
  <footer className="bg-gray-900 text-white py-8">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="flex flex-wrap justify-center gap-6 text-sm">
        <Link to="/legal/privacy" className="hover:text-gray-300">
          Privacy Policy
        </Link>
        <Link to="/legal/terms" className="hover:text-gray-300">
          Terms & Conditions
        </Link>
        <Link to="/legal/cookies" className="hover:text-gray-300">
          Cookies Policy
        </Link>
        <Link to="/legal/disclaimer" className="hover:text-gray-300">
          Disclaimer
        </Link>
        <Link to="/legal/refunds" className="hover:text-gray-300">
          Refund Policy
        </Link>
      </div>
...
const ContactInfo: React.FC<ContactInfoProps> = ({
  ...
  <div className={className}>
    ...
    <div className="space-y-1">
      <p>
        <strong>RepMotivatedSeller</strong>
      </p>
      {department && (
        <p>
          <em>{department}</em>
      ...
      {address && (
        <p>
          <span className="text-gray-600">Address:</span> {address}
        </p>
      )}
    </div>
  </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-green-50 border-l-4 border-green-400 p-4">
              ...
              <ul className="list-disc list-inside text-green-700 space-y-1">
                ...
                <li>
                  <strong>Referral Information:</strong> Source of website visit
                </li>
              </ul>
            </div>
          </div>
        ...
        <section id="gdpr-rights" className="print-break">
          ...
          <div className="bg-purple-50 border border-purple-200 p-4 rounded-lg">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <ul className="list-disc list-inside text-purple-700 space-y-1">
                <li>
                  <strong>Right to Portability:</strong> Transfer your data
                </li>
                <li>
                ...
                <li>
                  <strong>Right to Complain:</strong> To supervisory authorities
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
            ...
            <section>
              ...
              <p>
                By accessing and using RepMotivatedSeller services, you agree to
            ...
            <section>
              ...
              <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded-r-lg">
                <p className="text-yellow-800">
                  <strong>Important:</strong> RepMotivatedSeller is not a law
                  firm and does not provide legal advice. We connect you with
                  licensed professionals who can provide appropriate guidance
                  for your situation.
                </p>
              </div>
            </section>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
            ...
            <section>
              ...
              <p>
                RepMotivatedSeller is not a law firm. Use of our services does
                not create an attorney-client relationship. We provide
                information and connections to licensed professionals, but do
        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
            ...
            <section>
              ...
              <p>
                RepMotivatedSeller is committed to providing valuable services.
