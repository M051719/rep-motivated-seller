...
const FSBOListing: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const listingData = {
        ...
        year_remodeled: formData.year_remodeled ? parseInt(formData.year_remodeled) : null,
        ...
        basement_sqft: formData.basement_sqft ? parseInt(formData.basement_sqft) : null,
      ...
      const { error } = await supabase.from('fsbo_listings').insert([listingData]);
      ...
      // Reset form
      setFormData({
        owner_name: '', owner_phone: '', address: '', city: 'Los Angeles', zip_code: '',
        asking_price: '', bedrooms: '', bathrooms: '', square_feet: '', lot_size: '',
        year_built: '', property_tax: '', property_condition: 'good', year_remodeled: '',
        home_style: 'single-family', garage_spaces: '2', garage_attached: true,
        has_den: false, has_dining_room: false, has_recreation_room: false,
        has_office: false, has_loft: false, has_sun_room: false, has_shed: false,
        has_barn: false, has_dog_pen: false, water_type: 'city', electricity_type: 'standard',
        has_solar: false, ac_type: 'central', heating_type: 'central',
        hot_water_type: 'tank', has_basement: false, basement_type: '', basement_sqft: '',
        has_adu: false, is_free_and_clear: false, existing_loans: '',
  ...
  const filteredListings = listings.filter((listing) => {
    ...
    const matchesBedrooms = bedroomFilter === 'all' || listing.bedrooms.toString() === bedroomFilter;
    
    let matchesPrice = true;
    if (priceRange === '0-300k') matchesPrice = listing.asking_price < 300000;
    else if (priceRange === '300k-500k') matchesPrice = listing.asking_price >= 300000 && listing.asking_price < 500000;
    else if (priceRange === '500k-750k') matchesPrice = listing.asking_price >= 500000 && listing.asking_price < 750000;
    else if (priceRange === '750k+') matchesPrice = listing.asking_price >= 750000;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-500 max-w-3xl mx-auto">
            List your home for free! Perfect for For Sale By Owner (FSBO) and pre-foreclosure properties.
            No fees, no commissions—connect directly with buyers.
          </p>
        </div>
        ...
        <div className="text-center mb-12">
          ...
          >
            ...
            <span>{showForm ? 'Hide Listing Form' : 'List Your Home FREE'}</span>
          </button>
        </div>
        ...
        {showForm && (
          ...
          >
            <h2 className="text-3xl font-bold text-gray-900 mb-6">Create Your Free Listing</h2>
            <form onSubmit={handleSubmit} className="space-y-6">
              {/* Owner Information */}
              <div className="bg-gray-50 rounded-xl p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-4">Owner Contact Information</h3>
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-4">Additional Rooms & Features</h3>
                <div className="grid md:grid-cols-3 gap-4">
                  {[
                  ...
                  <div>
                    <label className="flex items-center space-x-2 cursor-pointer mt-8">
                      <input
                        ...
                        onChange={(e) =>
                          setFormData({ ...formData, garage_attached: e.target.checked })
                        }
                        className="w-5 h-5 text-green-600 border-gray-300 rounded focus:ring-green-500"
                      />
              ...
              {/* Utilities & Systems */}
              <div className="bg-gray-50 rounded-xl p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-4">Utilities & Systems</h3>
                <div className="grid md:grid-cols-3 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Air Conditioning
              ...
              {/* Financing */}
              <div className="bg-gray-50 rounded-xl p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-4">Financing Information</h3>
                <div>
                  <label className="flex items-center space-x-2 cursor-pointer mb-4">
                    <input
                      ...
                      onChange={(e) =>
                        setFormData({ ...formData, is_free_and_clear: e.target.checked })
                      }
                      className="w-5 h-5 text-green-600 border-gray-300 rounded focus:ring-green-500"
                    />
                  ...
                  {!formData.is_free_and_clear && (
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={(e) =>
                          setFormData({ ...formData, existing_loans: e.target.value })
                        }
                        rows={3}
              ...
              {/* Property Images */}
              <div className="bg-gray-50 rounded-xl p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-4">Property Photos</h3>
                <ImageUploader
                ...
                <p className="text-sm text-gray-600 mt-2">
                  Upload photos of your property. First image will be the featured image.
                </p>
              </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
          <h3 className="text-xl font-bold text-gray-900 mb-4">Filter Listings</h3>
          <div className="grid md:grid-cols-3 gap-4">
            <div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredListings.map((listing, index) => (
              ...
              >
                ...
                {/* Property Details */}
                <div className="p-6">
                  <h3 className="text-xl font-bold text-gray-900 mb-2">{listing.address}</h3>
                  ...
                  <div className="grid grid-cols-3 gap-3 mb-4 text-sm">
                    ...
                    <div className="flex items-center space-x-1">
                      ...
                      <span className="font-semibold">{listing.square_feet.toLocaleString()} sqft</span>
                    </div>
                  </div>
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-200">
                    ...
                    <p className="font-semibold text-gray-900">{listing.owner_name}</p>
                    <p className="text-green-600 font-semibold">{listing.owner_phone}</p>
                  </div>
                </div>
              </motion.div>
            ))}
