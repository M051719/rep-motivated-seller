    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      ...
      <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow">
        ...
        <p className="text-gray-700 mb-4">
          Thank you for choosing RepMotivatedSeller - Foreclosure Assistance
          Platform for your foreclosure assistance needs.
        </p>
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-8">
          <p className="text-gray-800">
            <strong>Our Commitment:</strong> We stand behind our foreclosure
            assistance services and want to ensure your complete satisfaction
            with our platform.
          </p>
        </div>
        ...
        <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
          ...
          <li>
            ...
            "Us" or "Our" in this Agreement) refers to sofie's investment group
            llc, 14603 gilmore street apt 7.
          </li>
          <li>
            <strong>Services</strong> refer to the foreclosure assistance
            services offered through the platform.
          </li>
          <li>
            <strong>Orders</strong> mean a request by You to purchase Services
            from Us.
          </li>
          <li>
        ...
        <p className="text-gray-700 mb-6">
          Due to the nature of our foreclosure assistance services, refunds are
          handled on a case-by-case basis. We understand that foreclosure
          situations are unique and time-sensitive.
        </p>
