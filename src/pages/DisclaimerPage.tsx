      ...
      <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow">
        ...
        <div className="bg-red-50 border border-red-200 rounded-lg p-6 mb-8">
          <p className="text-gray-800">
            <strong>Important Notice:</strong> This disclaimer contains
            important information about the limitations of our foreclosure
            assistance services. Please read carefully before using our
            platform.
          </p>
        </div>
        ...
        <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
          <li>
            ...
            "Us" or "Our" in this Disclaimer) refers to sofie's investment group
            llc, 14603 gilmore street.
          </li>
          <li>
            <strong>Service</strong> refers to the Website or the Application or
            both.
          </li>
          <li>
          ...
          <li>
            <strong>Website</strong> refers to RepMotivatedSeller - Foreclosure
            Assistance Platform, accessible from{" "}
            <a
              href="https://repmotivatedseller.shoprealestatespace.org"
              target="_blank"
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 mb-8">
          ...
          <p className="text-gray-700 mb-3">
            The information provided through our foreclosure assistance platform
            is for informational purposes only and should not be considered
            legal advice. Every foreclosure situation is unique and may require
            professional legal counsel.
          </p>
          <p className="text-gray-700">
            We strongly recommend consulting with a qualified attorney or
            HUD-approved housing counselor before making any decisions regarding
        ...
        <p className="text-gray-700 mb-6">
          Property valuations, market analyses, and foreclosure assistance
          information provided through our platform are estimates based on
          available data and should not be solely relied upon for making
          financial or legal decisions. Always verify information with qualified
          professionals.
        </p>
