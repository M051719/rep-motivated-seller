...
const HomePage: React.FC = () => {
  ...
  return (
    <>
      {/* Temporary Debug: Scroll to Top Button */}
      <button
        onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}
        className="fixed bottom-4 right-4 z-50 bg-red-600 text-white p-4 rounded-full shadow-lg hover:bg-red-700 transition-all"
        style={{ fontSize: "24px" }}
      >
        ⬆️ TOP
      </button>
      ...
      <Helmet>
        <title>
          RepMotivatedSeller - Save Your Home from Foreclosure | 24/7 Expert
          Help
        </title>
        <meta
          name="description"
          content="Complete foreclosure assistance ecosystem with 24/7 AI support, expert education, and community help. We've helped 1,250+ families save their homes. Free consultation available."
        />
        <meta
          name="keywords"
          content="foreclosure help, save home, foreclosure prevention, mortgage assistance, foreclosure attorney, home loan modification"
        />
        <meta
          property="og:title"
          content="Save Your Home - Transform Your Future | RepMotivatedSeller"
        />
        <meta
          property="og:description"
          content="Complete foreclosure assistance with 24/7 AI support and expert education. Free consultation available now."
        />
  ...
  <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-purple-800 text-white overflow-hidden">
    ...
    <div className="relative max-w-7xl mx-auto px-4 py-20 sm:py-32">
      <div className="text-center">
        ...
        >
          Complete foreclosure assistance ecosystem: 24/7 AI support, expert
          education, direct outreach, and a community that cares. We've helped{" "}
          <strong className="text-yellow-300">
            {stats.familiesHelped.toLocaleString()} families
          </strong>{" "}
          save their homes.
        </motion.p>
        ...
        >
          {user ? (
            <>
              ...
              <Link
                to="/credit-repair/dashboard"
                className="bg-purple-600 text-white px-6 sm:px-8 py-4 rounded-lg font-bold text-lg hover:bg-purple-700 transition-all duration-300 transform hover:scale-105 shadow-lg"
                onClick={() => onCTAClick("credit_repair")}
              >
                💳 Credit Repair
              </Link>
              <Link
                to="/direct-mail"
                className="bg-gradient-to-r from-pink-600 to-purple-600 text-white px-6 sm:px-8 py-4 rounded-lg font-bold text-lg hover:from-pink-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 shadow-lg"
                onClick={() => onCTAClick("direct_mail")}
              >
                📬 Direct Mail
              </Link>
            </>
            ...
            <>
              ...
              <Link
                to="/fsbo-listing"
                className="bg-gradient-to-r from-green-600 to-emerald-600 text-white px-6 sm:px-8 py-4 rounded-lg font-bold text-lg hover:from-green-700 hover:to-emerald-700 transition-all duration-300 transform hover:scale-105 shadow-xl"
                onClick={() => onCTAClick("fsbo_listing")}
              >
                🏡 FREE FSBO Listing
              </Link>
              <Link
...
const ServicesOverview = memo<{ onServiceClick: (type: string) => void }>(
  ({ onServiceClick }) => (
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            We've built the most comprehensive foreclosure prevention system
            ever created
          </p>
        </div>
          ...
          {[
            ...
            >
              ...
              <Link
                ...
                onClick={() =>
                  onServiceClick(
                    `service_${service.title.toLowerCase().replace(/\s+/g, "_")}`,
                  )
                }
              >
                Learn More
...
const ContactCTA = memo<{ onCTAClick: (type: string) => void }>(
  ({ onCTAClick }) => (
    <section className="py-20 bg-gradient-to-r from-red-600 via-red-700 to-orange-600 text-white relative overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto text-center px-4">
        ...
        >
          Don't wait another day. Every moment matters when your home is at
          risk. Get immediate expert help - completely free.
        </motion.p>
...
const LoanApplicationCTA = memo<{ onCTAClick: (type: string) => void }>(
  ({ onCTAClick }) => (
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-green-100 text-sm">
                    Short-term financing that works for you
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-green-100 text-sm">
                    Secure, transparent, and trustworthy lending
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Read and agree to our zero tolerance fraud policy and terms
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Fill out your property and financial information
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Submit required documents with easy upload
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Receive decision within 7 business days
                  </p>
                </div>
              </div>
            </div>
