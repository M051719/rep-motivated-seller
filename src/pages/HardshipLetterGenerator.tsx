...
import { FileText, Download, Mail, Calendar, Home, DollarSign, AlertCircle, ChevronRight, CheckCircle, Printer } from 'lucide-react';
...
const templates: LetterTemplate[] = [
  {
    ...
    description: 'Request loan modification or forbearance to prevent foreclosure',
  ...
  },
  {
    ...
    description: 'Explain late mortgage payment and request waiver of late fees',
    category: 'payment',
...
${formData.email}`;
  ...
  const isFormValid = () => {
    return formData.fullName && formData.email && formData.lenderName && 
           formData.hardshipDescription && formData.requestedAction;
  };
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Create professional hardship letters in minutes. No sign-up required. 
            Fill in your information and download a personalized letter instantly.
          </p>
        ...
        <div className="mb-8">
          <div className="flex items-center justify-center space-x-4">
            <div className={`flex items-center space-x-2 ${step === 'select' ? 'text-blue-600 font-semibold' : 'text-gray-400'}`}>
              <div className={`w-8 h-8 rounded-full flex items-center justify-center ${step === 'select' ? 'bg-blue-600 text-white' : 'bg-gray-200'}`}>1</div>
              <span>Choose Template</span>
            </div>
            <ChevronRight className="w-5 h-5 text-gray-400" />
            <div className={`flex items-center space-x-2 ${step === 'fill' ? 'text-blue-600 font-semibold' : 'text-gray-400'}`}>
              <div className={`w-8 h-8 rounded-full flex items-center justify-center ${step === 'fill' ? 'bg-blue-600 text-white' : 'bg-gray-200'}`}>2</div>
              <span>Fill Information</span>
            </div>
            <ChevronRight className="w-5 h-5 text-gray-400" />
            <div className={`flex items-center space-x-2 ${step === 'preview' ? 'text-blue-600 font-semibold' : 'text-gray-400'}`}>
        ...
        {step === 'fill' && (
          ...
          >
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Fill in Your Information</h2>
              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">Lender/Creditor Name *</label>
                      <input
                        type="text"
                    ...
                    <div className="md:col-span-2">
                      <label className="block text-sm font-medium text-gray-700 mb-1">Lender Address</label>
                      <input
                        type="text"
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">Type of Hardship *</label>
                      <select
                        value={formData.hardshipType}
                        onChange={(e) => handleInputChange('hardshipType', e.target.value)}
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      >
                    ...
                    <div className="grid md:grid-cols-3 gap-4">
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Hardship Start Date</label>
                        <input
                          type="date"
                          value={formData.hardshipDate}
                          onChange={(e) => handleInputChange('hardshipDate', e.target.value)}
                          className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        />
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Income Reduction %</label>
                        <input
                          type="number"
                          value={formData.incomeReduction}
                          onChange={(e) => handleInputChange('incomeReduction', e.target.value)}
                          className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                          placeholder="50"
                        />
                      </div>
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">Describe Your Hardship *</label>
                      <textarea
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">What Are You Requesting? *</label>
                      <input
                        type="text"
        ...
        {step === 'preview' && (
          ...
          >
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Your Hardship Letter</h2>
              ...
              <div className="mt-8 bg-blue-50 rounded-lg p-6 border border-blue-200">
                ...
                <ol className="list-decimal list-inside space-y-2 text-gray-700">
                  <li>Download your letter using the buttons above (PDF recommended)</li>
                  ...
                  <li>Follow up with your lender/creditor in 7-10 business days</li>
              ...
              <div className="mt-6 bg-yellow-50 rounded-lg p-6 border border-yellow-200">
                <h3 className="text-lg font-bold text-gray-900 mb-3">📎 Required Supporting Documents:</h3>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">Income Verification:</h4>
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">Hardship Proof:</h4>
                    <ul className="space-y-1 text-sm text-gray-700">
                      <li className="flex items-start space-x-2">
                        <span className="text-green-600 mt-0.5">✓</span>
                ...
                <div className="mt-4 p-3 bg-white rounded border border-yellow-300">
                  <p className="text-sm text-gray-700">
                    <strong>💡 Pro Tip:</strong> Organize documents in the order listed above. Include a cover sheet with a table of contents. Number each page for easy reference.
                  </p>
                </div>
              </div>
              ...
              <div className="mt-8 bg-gradient-to-r from-purple-600 to-blue-600 rounded-lg p-6 text-white">
                ...
                <p className="mb-4">Join RepMotivatedSeller for personalized foreclosure assistance, one-on-one consultations, and access to our complete resource library.</p>
                <button
          ...
          >
            ...
            >
              <div className="text-center">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Letter Downloaded Successfully!</h3>
                <p className="text-gray-600 mb-6">
                  We've sent helpful tips and next steps to <strong>{formData.email}</strong>
                </p>
