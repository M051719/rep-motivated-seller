      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <h3 style={{ fontSize: '1.2rem', marginBottom: '0.5rem', color: '#1976d2' }}>
              📊 System Status
            </h3>
          ...
          <div style={{
            ...
            <h3 style={{ fontSize: '1.2rem', marginBottom: '0.5rem', color: '#f57c00' }}>
              📱 Send Test SMS
            </h3>
          ...
          <div style={{ marginTop: '30px', padding: '15px', backgroundColor: '#f5f5f5', borderRadius: '6px' }}>
            ...
            <ol style={{ margin: '10px 0', paddingLeft: '20px', color: '#555' }}>
          ...
          <div style={{ marginTop: '20px', fontSize: '0.9rem', color: '#999', textAlign: 'center' }}>
            <p>
              Full dashboard with real-time updates will be available once the circular dependency is resolved.
            </p>
          </div>
        </div>
      </div>
