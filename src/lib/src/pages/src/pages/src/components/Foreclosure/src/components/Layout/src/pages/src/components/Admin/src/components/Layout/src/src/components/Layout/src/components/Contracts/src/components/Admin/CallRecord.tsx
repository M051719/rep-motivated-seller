  ...
  const fetchCallData = async () => {
    try {
      ...
      const { data: analyticsData, error: analyticsError } =
        await supabase.functions.invoke("call-analytics", {
          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Monitor and manage AI-assisted calls
              </p>
            </div>
          </div>
          <button
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-2xl font-bold text-green-900">
                      {analytics.overview.completedCalls}
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-2xl font-bold text-purple-900">
                      {analytics.overview.transferredCalls}
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-semibold text-green-600">
                      {analytics.aiPerformance.fulfillmentRate}%
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-semibold text-purple-600">
                      {analytics.overview.transferRate}%
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <div className="space-y-3">
                  {analytics.aiPerformance.topIntents
                    .slice(0, 5)
                        ...
                        <div className="flex items-center">
                          <div className="w-16 bg-gray-200 rounded-full h-2 mr-2">
                            <div
                              ...
                              style={{
                                width: `${(count / analytics.aiPerformance.topIntents[0][1]) * 100}%`,
                              }}
                            />
                          </div>
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="ml-3">
                        ...
                        <p className="text-sm text-gray-600">
                          {call.primary_intent || "No intent detected"}
                        </p>
                      </div>
                    </div>
                    <div className="flex items-center space-x-3">
                      <span
                        className={`px-2 py-1 text-xs rounded-full border ${getPriorityColor(call.priority_level)}`}
                      >
                        {call.priority_level}
                      </span>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-purple-50 rounded-lg p-6">
                ...
                <p className="text-sm text-purple-700">For transferred calls</p>
              </div>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              <div className="space-y-3">
                {analytics.handoffAnalysis.commonReasons.map(
                  ([reason, count], index) => (
                    <div
                      key={reason}
                      className="flex items-center justify-between"
                      ...
                      <div className="flex items-center">
                        <div className="w-24 bg-gray-200 rounded-full h-2 mr-3">
                          <div
                            ...
                            style={{
                              width: `${(count / analytics.handoffAnalysis.commonReasons[0][1]) * 100}%`,
                            }}
                          />
                        </div>
                        <span className="text-sm font-medium text-gray-900">
        ...
        {activeTab === "live" && (
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              {calls.filter((call) => call.call_status === "in-progress")
                .length === 0 ? (
                ...
                <div className="space-y-3">
                  {calls
                    .filter((call) => call.call_status === "in-progress")
                    .map((call) => (
                      <div
                        key={call.id}
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    ...
                    {(call.call_duration % 60).toString().padStart(2, "0")}
                  </span>
                </div>
                <div className="flex justify-between">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    {call.primary_intent || "None detected"}
                  </span>
                </div>
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    {call.ai_confidence_score
                      ? `${Math.round(call.ai_confidence_score * 100)}%`
                      : "N/A"}
                  </span>
                </div>
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    {call.requires_human_followup ? "Yes" : "No"}
                  </span>
                </div>
              </div>
            </div>
