...
export async function syncContactToCRM(response: ForeclosureResponse): Promise<string | null> {
...
// HubSpot Integration
async function syncToHubSpot(response: ForeclosureResponse, config: CRMConfig): Promise<string> {
  if (!config.apiKey) {
...
async function syncToSalesforce(response: ForeclosureResponse, config: CRMConfig): Promise<string> {
...
async function syncToPipedrive(response: ForeclosureResponse, config: CRMConfig): Promise<string> {
  if (!config.apiKey) {
...
async function syncToCustomCRM(response: ForeclosureResponse, config: CRMConfig): Promise<string> {
